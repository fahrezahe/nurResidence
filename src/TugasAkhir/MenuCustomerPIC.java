...
public class MenuCustomerPIC extends javax.swing.JFrame {
    /**
    ...
    private void initComponents() {
        ...
        jMenuItem7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/home.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCustomerPIC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCustomerPIC().setVisible(true);
            }
        });
    }
