...
public class MenuPIC extends javax.swing.JFrame {
    /**
    ...
    public MenuPIC() {
        ...
        tblpic.setModel(model);
        tampilkanDataTabel(); // Panggil metode tampilkanDataTabel() di sini
        tblpic.addMouseListener(new java.awt.event.MouseAdapter() {
        @Override
        public void mouseClicked(java.awt.event.MouseEvent evt) {
            tblpicMouseClicked(evt);
        }
    });
    ...
    private void initComponents() {
        ...
        txtpwpic = new javax.swing.JTextField();
        jLabel8 = new javax.swing.JLabel();
        cbjk = new javax.swing.JComboBox<>();
        txtusspic = new javax.swing.JTextField();
        ...
        txtidpic = new javax.swing.JTextField();
        jPanel2 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tblpic = new javax.swing.JTable();
        ...
        jLabel11.setText("Id PIC");

        txtidpic.setBorder(null);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtidpic, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtpwpic, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel11)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtidpic, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel3)
                .addGap(7, 7, 7)
                ...
                .addComponent(jLabel8)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtusspic, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel7)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtpwpic, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(41, 41, 41)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        tblpic.setBackground(new java.awt.Color(253, 253, 253));
        tblpic.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(tblpic);
    ...
    private boolean isNamaExist(String namaLengkap) throws SQLException { //cek nama sudah ada
    ...
    try {
        ...
        String query = "SELECT COUNT(*) FROM pic WHERE nama_lengkap = ?";
...
private boolean isIdPicExist(String id_pic) throws SQLException { //cek id sudah ada
    Connection conn = null;
    PreparedStatement ps = null;
    ResultSet rs = null;
    try {
...
private boolean isUsernameExist(String username) throws SQLException { // cek username sudah ada
    Connection conn = null;
    PreparedStatement ps = null;
    ResultSet rs = null;
    try {
        ...
        conn = dbconnection.koneksi();
        // Query SQL untuk memeriksa apakah nama sudah ada dalam tabel pic
        String query = "SELECT COUNT(*) FROM pic WHERE username = ?";
        ps = conn.prepareStatement(query);
    ...
    private void mnlogoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnlogoutActionPerformed
        ...
        while (rs.next()) {
            ...
            String id_pic = rs.getString("id_pic");
            ...
            model.addRow(new Object[]{id_pic, namaLengkap, noHp, alamat, jenisKelamin, username, password});
        }
    ...
    try {
        ...
        String idPicToDelete = txtidpic.getText(); // Gantilah dengan komponen input yang sesuai

        // Query SQL untuk menghapus data berdasarkan id_pic
        String deleteQuery = "DELETE FROM pic WHERE id_pic = ?";
        PreparedStatement deletePS = conn.prepareStatement(deleteQuery);
        deletePS.setString(1, idPicToDelete);
    ...
    private void btntambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntambahActionPerformed
     try {
        ...
        String id_pic_input = txtidpic.getText(); // Mengambil nilai dari JTextField txtidpic
        String id_pic = String.format("PIC-%02d", Integer.parseInt(id_pic_input)); // Memformat nilai menjadi "PIC-XX"
        String namaLengkap = txtnamalengkap.getText();
        String noHp = txtnohp.getText();
        String alamat = txtalamat.getText();
        String jenisKelamin = (String) cbjk.getSelectedItem();  
        String username = txtusspic.getText();
        String password = txtpwpic.getText();

        // Memeriksa apakah ada kolom yang kosong
        if (namaLengkap.isEmpty() || noHp.isEmpty() || alamat.isEmpty() || username.isEmpty() || password.isEmpty()) {
        ...
        // Memeriksa keberadaan ID PIC, nama lengkap, dan username dalam database
        if (isIdPicExist(id_pic)) {
            JOptionPane.showMessageDialog(rootPane, "ID PIC Sudah Ada!");
            return; // Keluar dari method jika ID PIC sudah ada
        }

        if (isNamaExist(namaLengkap)) {
            JOptionPane.showMessageDialog(rootPane, "Nama PIC Sudah Ada!");
            return; // Keluar dari method jika nama PIC sudah ada
        }
        ...
        // Jika tidak ada yang sama, tambahkan data ke database
        String insertQuery = "INSERT INTO pic (id_pic, nama_lengkap, nohp, alamat, jeniskl, username, password) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    try {
        ...
        // Pengambilan nilai dari inputan pengguna
        String idPicToUpdate = txtidpic.getText(); // Gantilah dengan komponen input yang sesuai
        String namaLengkap = txtnamalengkap.getText();
        String noHp = txtnohp.getText();
        String alamat = txtalamat.getText();
        String jenisKelamin = (String) cbjk.getSelectedItem();  
        ...
        String checkIdPicQuery = "SELECT COUNT(*) FROM pic WHERE id_pic = ?";
        PreparedStatement checkIdPicPS = conn.prepareStatement(checkIdPicQuery);
        checkIdPicPS.setString(1, idPicToUpdate);
        ResultSet rs = checkIdPicPS.executeQuery();
        ...
        if (count == 0) {
            ...
            // Query SQL untuk mengubah data pada tabel pic
            String updateQuery = "UPDATE pic SET nama_lengkap = ?, nohp = ?, alamat = ?, jeniskl = ?, username = ?, password = ? WHERE id_pic = ?";
    ...
    try {
        ...
        String searchQuery = "SELECT * FROM pic WHERE id_pic LIKE ? OR nama_lengkap LIKE ? OR alamat LIKE ? OR nohp LIKE ? OR jeniskl LIKE ? OR username LIKE ? OR password LIKE ?";
        ...
        DefaultTableModel model = (DefaultTableModel) tblpic.getModel();
        model.setRowCount(0);
    ...
    private void tblpicMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpicMouseClicked
        // TODO add your handling code here:
    int baris = tblpic.rowAtPoint(evt.getPoint());

    // Mengisi formulir dengan data dari baris yang diklik
    txtidpic.setText(tblpic.getValueAt(baris, 0).toString());
    txtnamalengkap.setText(tblpic.getValueAt(baris, 1).toString());
    txtnohp.setText(tblpic.getValueAt(baris, 2).toString());
    txtalamat.setText(tblpic.getValueAt(baris, 3).toString());
    // Pilihan jenis kelamin
    String jenisKelamin = tblpic.getValueAt(baris, 4).toString();
    cbjk.setSelectedItem(jenisKelamin);
    
    txtusspic.setText(tblpic.getValueAt(baris, 5).toString());
    txtpwpic.setText(tblpic.getValueAt(baris, 6).toString());        
    }//GEN-LAST:event_tblpicMouseClicked

    private void btnprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnprintActionPerformed
        try {
        // Mendapatkan input stream dari file JasperReport
        InputStream reportStream;
            reportStream = getClass().getResourceAsStream("/Reports/Report_DataPIC.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPIC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblpic;
    private javax.swing.JTextField txtalamat;
    private javax.swing.JTextField txtidpic;
    private javax.swing.JTextField txtnamalengkap;
    private javax.swing.JTextField txtnohp;
    private javax.swing.JTextField txtpwpic;
    private javax.swing.JTextField txtsearch;
    private javax.swing.JTextField txtusspic;
