...
public class MenuLaporanBulananPIC extends javax.swing.JFrame {
    /**
...
private void hitungKeuntungan() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuLaporanBulananPIC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuLaporanBulananPIC().setVisible(true);
            }
        });
    }
